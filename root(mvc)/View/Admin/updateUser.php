...
function VIEW_updateUser($username)
{
?>
    <html>
    ...
    <head>
        ...
        <script>
            ...
            // try {
            //     let obj = document.getElementById("disableBtn");
            //     obj.setAttribute("value", "200");
            //     // alert(10);
            // } catch {
            //     // alert('er');
            //     alert(username);
            ...
            function requestUserInfo() {
                ...
                xhttp.open('GET', 'redirect.php?getUserInfo=' + username, true);
                xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhttp.send();
                // xhttp.send('username=' + JSON.stringify('admin'));
                // alert(username);
                        ...
                        <tbody class="tbody">
                            <tr>
                                <td colspan="2">
                                    ...
                                    <button class="btn" id="disableBtn" name="disableAccount" type="submit">Toggle Active Status</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <!-- <input type="submit" name="home" value="Back"> -->
                                    <button class="btn" type="submit" name="listUsers">Back</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
